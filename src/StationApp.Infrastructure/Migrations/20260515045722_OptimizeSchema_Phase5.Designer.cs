            ...
            modelBuilder.Entity("StationApp.Domain.Entities.AppConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ConfigKey = "OverweightSplitStepWeight",
                            ConfigValue = "0.0025",
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            CreatedBy = "SYSTEM",
                            UpdatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
            ...
            modelBuilder.Entity("StationApp.Domain.Entities.DeliveryTicket", b =>
                {
                    ...
                    b.HasIndex("SyncStatus")
                        .HasDatabaseName("IX_delivery_tickets_sync_status");

                    b.HasIndex("VehicleRegistrationId")
                        .HasDatabaseName("IX_delivery_tickets_vehicle_registration_id");
