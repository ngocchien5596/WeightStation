...
public class CutOrderEntityConfiguration : IEntityTypeConfiguration<CutOrder>
{
    public void Configure(EntityTypeBuilder<CutOrder> builder)
    {
        ...
        builder.Property(e => e.OrderCode).HasMaxLength(500);
        ...
        builder.HasIndex(e => new { e.StationCode, e.IsPortTransfer, e.TransactionType, e.IsDeleted })
               .HasDatabaseName("IX_cut_orders_station_port_transfer");
