        ...
        using (Helpers.PerformanceLogger.Track("DI Container Build"))
        {
            _host = Host.CreateDefaultBuilder()
                ...
                .ConfigureServices((context, services) =>
                {
                    ...
                    services.AddScoped<UpdateTemporaryExportCutOrderUseCase>();
                    ...
                    services.AddScoped<CreateClayTemporaryCutOrderUseCase>();
                    services.AddScoped<UpdateClayVesselUseCase>();
                    services.AddScoped<CreateClayVehicleSessionUseCase>();
                    services.AddScoped<CreateClayPendingVehicleTripUseCase>();
                    services.AddScoped<CaptureClayWeight1ForTripUseCase>();
                    services.AddScoped<CompleteClayVehicleSessionLineUseCase>();
                    services.AddScoped<FinalizeClayCutOrderUseCase>();
                    services.AddScoped<TransferClayVehicleTripUseCase>();
