...
public partial class CrusherInboundReportViewModel : ObservableObject
{
    ...
    private readonly GetCrusherInboundReportLookupOptionsUseCase _lookupOptionsUseCase;
    ...
    public CrusherInboundReportViewModel(
        ...
        GetCrusherInboundReportLookupOptionsUseCase lookupOptionsUseCase,
        IClock clock,
    ...
    private async Task ExportAsync()
    {
        ...
        {
            Title = "Xuất báo cáo nhập trạm đập",
            Filter = "Excel Workbook (*.xlsx)|*.xlsx",
            DefaultExt = ".xlsx",
            AddExtension = true,
            InitialDirectory = GetDefaultReportFolder(),
            FileName = $"BaoCaoNhapTramDap_{fromTime:yyyyMMdd_HHmmss}_{toTime:yyyyMMdd_HHmmss}.xlsx"
        };
