...
public partial class ExportWeighingViewModel : ObservableObject, IDisposable, IWeighingDeviceHost
{
    ...
    [ObservableProperty] private Brush _stabilityBrush = UnstableBrush;
            ...
            var weighPages = ticketsToPrint
                .Select(ticket =>
                {
                    ...
                    var page = composer.Compose(
                        ...
                        cutOrderCodeOverride: cutOrderCode);
                    if (ticket.RecordRole == WeighTicketRecordRoles.MasterSession)
                    {
